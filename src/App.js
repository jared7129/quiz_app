...
// Quizzes rendered are the json files taken from quizzes directory
class App extends Component {
  state = {
    quizes: [
      { id: 'quizzes/got.json', name: 'Game of Thrones' },
      { id: 'quizzes/bb.json', name: 'Breaking Bad' }
    ],
    quizId: 'quizzes/got.json'
  };
